    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharePost.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                StorageReference storageReference = FirebaseStorage.getInstance().getReference("Posts/"+id+"image.jpg");
                            ...
                            storageReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    PostModel postModel = new PostModel(id, FirebaseAuth.getInstance().getUid(),postText.getText().toString(),
                                            SharedImageUri.toString(),"0","0", Calendar.getInstance().getTimeInMillis());
